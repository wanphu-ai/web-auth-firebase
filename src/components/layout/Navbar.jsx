...
const Navbar = () => {
  ...
  return (
    <nav className="w-full border-b border-slate-800/80 bg-slate-950/70 backdrop-blur-md sticky top-0 z-40 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          ...
          <span className="text-xl font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-600 bg-clip-text text-transparent">
            AuthHub
          </span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-slate-900/80 border border-slate-800 text-slate-300 hover:text-indigo-400 hover:border-indigo-500/40 transition duration-200 cursor-pointer flex items-center justify-center"
          ...
          {currentUser ? (
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                to="/login"
                className="text-sm font-medium text-slate-300 hover:text-indigo-500 px-3 py-1.5 transition"
              >
                Đăng nhập
              </Link>
              <Link
